...
public class PinyinUtil {
	...
	private static String concatPinyinStringArray(String[] pinyinArray)
	 ...
	 public static void main(String[] args) {
		 ...
		 String outputString = PinyinUtil.covertCnNameToPinyin("纪","");
		 System.out.println("wwwwwwwwww"+outputString+"aaaa");
		 String outputString2 = PinyinUtil.covertCnNameToPinyin("少杰 你","");
		 System.out.println("wwwwwwwwww"+outputString2+"bbbb");
